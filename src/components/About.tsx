    ...
    <section className="py-20 px-8 section-gradient" id="about">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-12 items-center">
          <div className="flex justify-center mx-auto md:col-span-1">
          ...
          <div className="space-y-6 md:col-span-2">
            <p className="text-lg text-gray-300 leading-relaxed text-center md:text-left">
              I&apos;m an Electronics & Computer Science undergraduate at University
              of Kelaniya with a deep passion for blockchain technology and
            ...
            <div className="grid grid-cols-1 gap-4 pt-4 md:grid-cols-2 ">
              <div className="glass-card p-4 hover:bg-white/10 hover:scale-101 hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300 cursor-default">
                <p className="text-lg font-medium text-gray-300 gap-2.5 flex items-center">
              ...
              <div className="glass-card p-4 hover:bg-white/10 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 cursor-default">
                <p className="text-lg font-medium text-gray-300">📍 Sri Lanka</p>
              </div>
            </div>
          </div>
        </div>
